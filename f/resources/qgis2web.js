...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [78478.552287, 2939279.051391, 477493.311156, 3151372.467879], maxZoom: 28, minZoom: 6, projection: new ol.proj.Projection({
            code: 'EPSG:5266',
...
map.getView().fit([78478.552287, 2939279.051391, 477493.311156, 3151372.467879], map.getSize());
